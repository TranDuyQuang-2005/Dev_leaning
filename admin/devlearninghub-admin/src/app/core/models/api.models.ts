...
export interface CurrentUser { id: number; userId?: number; fullName: string; userName: string; email: string; avatarUrl?: string | null; roles: string[]; permissions: string[]; effectivePermissions?: string[]; isAdminPortalAllowed?: boolean; }
